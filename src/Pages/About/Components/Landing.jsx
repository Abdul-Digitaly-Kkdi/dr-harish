...
const Landing = () => {
    return (
        <>
            <SEO
                title="About Dr Harish | Trusted Orthopaedic Surgeon in Trichy"
                description="Dr Harish is a trusted orthopaedic surgeon in Trichy with expertise in bone, joint, knee and sports injury treatments. Know more here."
            />
            <div
